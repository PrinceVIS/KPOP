module lab2{
    ...
    //     }
    // };
    let favoriteLibrarian : ILibrarian = new UniversityLibrarian("Doe", "librarian@mail.com", "librarians_deparment");
    ...
    let refBook : Encyclopedia = new Encyclopedia("EncyclopediaTitle", 2000, 5);
    refBook.printItem();
